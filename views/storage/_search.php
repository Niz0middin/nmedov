...
/** @var app\models\search\StorageViewSearch $model */
    ...
    <div class="row">
        <div class="col-lg-7 col-md-10 col-sm-12">
            <div class="input-group">
                ...
                <?= Html::a('<i class="fa fa-refresh"></i> Сбросить фильтр', Yii::$app->urlManager->createUrl('/storage/index'), ['class' => 'btn btn-warning', 'style' => 'display:inline-block;margin-left:10px;margin-right:10px']) ?>
            </div>
        </div>
    </div>
